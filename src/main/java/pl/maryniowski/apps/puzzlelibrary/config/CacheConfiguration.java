package pl.maryniowski.apps.puzzlelibrary.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pl.maryniowski.apps.puzzlelibrary.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pl.maryniowski.apps.puzzlelibrary.repository.UserRepository.USERS_BY_EMAIL_CACHE);
